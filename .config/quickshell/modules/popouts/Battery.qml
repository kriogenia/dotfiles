...
Column {
    ...
    component Profile: Item {
        ...
        StateLayer {
            radius: Appearance.rounding.full
            color: profiles.current === parent.icon ? Colours.palette.on_primary : Colours.palette.on_surface
        ...
        MaterialIcon {
            ...
            color: profiles.current === text ? Colours.palette.on_primary : Colours.palette.on_surface
